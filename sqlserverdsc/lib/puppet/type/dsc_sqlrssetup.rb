...
Puppet::ResourceApi.register_type(
  ...
  attributes: {
    ...
    dsc_action: {
      type: "Optional[Enum['Install', 'Uninstall', 'install', 'uninstall']]",
    ...
    dsc_edition: {
      type: "Optional[Enum['Development', 'Evaluation', 'ExpressAdvanced', 'development', 'evaluation', 'expressadvanced']]",
