...
This is an auto-generated module, using the [Puppet DSC Builder](https://www.powershellgallery.com/packages/puppet.dsc) to vendor and expose the [computermanagementdsc](https://www.powershellgallery.com/packages/computermanagementdsc/9.0.0) PowerShell module's DSC resources as Puppet resources.
The _functionality_ of this module comes entirely from the vendored PowerShell resources, which are pinned at [**v9.0.0**](https://www.powershellgallery.com/packages/computermanagementdsc/9.0.0).
The PowerShell module describes itself like this:

> _DSC resources for configuration of a Windows computer. These DSC resources allow you to perform computer management tasks, such as renaming the computer, joining a domain and scheduling tasks as well as configuring items such as virtual memory, event logs, time zones and power settings._
...
You'll need to [file an issue](https://github.com/dsccommunity/ComputerManagementDsc) with the upstream maintainers for the [PowerShell module](https://www.powershellgallery.com/packages/computermanagementdsc/9.0.0).
