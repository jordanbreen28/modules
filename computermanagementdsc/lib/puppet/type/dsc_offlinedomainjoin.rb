...
Puppet::ResourceApi.register_type(
  name: 'dsc_offlinedomainjoin',
  dscmeta_resource_friendly_name: 'OfflineDomainJoin',
  dscmeta_resource_name: 'DSC_OfflineDomainJoin',
  dscmeta_resource_implementation: 'MOF',
  dscmeta_module_name: 'ComputerManagementDsc',
  dscmeta_module_version: '9.0.0',
  docs: 'The DSC OfflineDomainJoin resource type.
  ...
  attributes: {
    ...
    dsc_requestfile: {
      type: 'String',
      desc: 'The full path to the Offline Domain Join Request file to use.',
