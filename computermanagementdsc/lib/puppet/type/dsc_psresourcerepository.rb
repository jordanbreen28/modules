...
Puppet::ResourceApi.register_type(
  name: 'dsc_psresourcerepository',
  dscmeta_resource_friendly_name: 'PSResourceRepository',
  dscmeta_resource_name: 'PSResourceRepository',
  dscmeta_resource_implementation: 'Class',
  dscmeta_module_name: 'ComputerManagementDsc',
  dscmeta_module_version: '9.0.0',
  docs: 'The DSC PSResourceRepository resource type.
  ...
  attributes: {
    ...
    dsc_installationpolicy: {
      type: "Optional[Enum['Untrusted', 'untrusted', 'Trusted', 'trusted']]",
      desc: ' ',
